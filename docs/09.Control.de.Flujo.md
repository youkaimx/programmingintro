...
- [Mecanismos de Control de Flujo](#mecanismos-de-control-de-flujo)
  ...
  - [Sentencia while](#sentencia-while)
    ...
    - [`while` controlado por una "bandera"](#while-controlado-por-una-%22bandera%22)
- [El programa correcto debe imprimir:](#el-programa-correcto-debe-imprimir)
- [Tiene 50](#tiene-50)
- [--------------------------------------------------](#)
- [Lo mismo pero de otra forma](#lo-mismo-pero-de-otra-forma)
- [--------------------------------------------------](#1)
...
En esta técnica, la iteración (repetición) del ciclo `while` está supeditada al valor de una variable contador. La variable debe ser declarada con un valor inicia, verificada en la expresión booleana del `while` y modificada dentro del where. Por ejemplo
